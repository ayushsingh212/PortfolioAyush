...
const handleSubmit = async (e) => {
  ...
  sender: { name: "Your Portfolio", email: "ayushsingh212109@gmail.com" },
  // The recipient remains your email
  to: [{ email: "ayushsingh212109@gmail.com", name: "Ayush Singh" }],
      ...
      <div className="relative z-10 container mx-auto max-w-7xl">
        ...
        >
          <div className="relative inline-block">
            <h2
              className={`text-2xl sm:text-4xl md:text-6xl lg:text-7xl font-bold mb-3 sm:mb-4 md:mb-6 ${
                isDarkMode
          ...
          >
            ...
            <div className="space-y-3 sm:space-y-4 md:space-y-6">
              <ContactInfo
                ...
                label="Email"
                value="ayushsingh212109@gmail.com"
                link="mailto:ayushsingh212109@gmail.com"
                delay="0ms"
            ...
            <div className="pt-4 sm:pt-6">
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4 justify-center sm:justify-start">
                ...
                />
                <SocialIcon
                  href="https://x.com/ayush_singh09"
                  icon={<Twitter size={16} />}
                  color="from-cyan-400 to-cyan-500"
                  label="Twitter"
                />
                <SocialIcon
                  href="https://www.instagram.com/9.thakur_ayush/"
